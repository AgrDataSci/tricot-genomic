...
* Can farmers' evaluations better predict varietal performance associated with genes?
* Can we use crowdsourcing to improve GxE estimates?
* What is the ability of local varieties to outperform varieties from other zones?


# Introduction

* Crowdsourcing citizen science showed the ability to register the climate effects as they occur in farms, with potential to be used in plant breeding programs and risk assessments for farm adaptation[@VanEtten2019].
